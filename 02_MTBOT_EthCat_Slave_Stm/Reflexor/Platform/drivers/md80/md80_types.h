...
/* The total device supported by this module. */
#define MD80_TOTAL_DEV_SUPPORT      (8U)
...
typedef enum
{
   ...
   MD80_FRAME_SET_TORQUE_BANDWIDTH = 0x06,
...
extern tMd80_Device md80Dev[MD80_TOTAL_DEV_SUPPORT];
