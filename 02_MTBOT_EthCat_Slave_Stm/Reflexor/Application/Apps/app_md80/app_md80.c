...
static void App_Md80_UpdateDataControl(void)
{
   ...
   {
      /* Update the data control for md80. */
      pAppMd80->pMd80[2]->input.velocity = MD80_ETH_TO_REAL(Obj.md80_2_DataControl.Velocity);
      pAppMd80->pMd80[2]->input.position = MD80_ETH_TO_REAL(Obj.md80_2_DataControl.Position);
      pAppMd80->pMd80[2]->input.torque = MD80_ETH_TO_REAL(Obj.md80_2_DataControl.Torque);
...
static void App_Md80_Command_Enter (tAppMd80_Data * const app)
{
   ...
   memcpy ((uint8_t *)app->cmd.data, (uint8_t *)app->hostReq.data, sizeof(tAppMd80_Msg));
...
static void App_Md80_UpdateResp (tAppMd80_Data * const app)
{
   ...
   /* Update to object. */
   Obj.md80_Respond.md80_dev_no = md80Id;
...
static tMd80_Device md80Dev[APP_MD80_TOTAL_DEV_SUPPORT] = {0};
...
//      bzero(pMd80_Devs, sizeof(tMd80_Device) * APP_MD80_TOTAL_DEV_SUPPORT);
      ...
      for (iter = 0u; iter < APP_MD80_TOTAL_DEV_SUPPORT; iter++)
      {
         pAppMd80->pMd80[iter] = (tMd80_Device *)&md80Dev[iter];
      }
   }
}
